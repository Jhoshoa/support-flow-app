...
requests_data = [
  { title: "Login page not loading", description: "Users report the login page shows a blank screen after the latest deploy.", status: :open, priority: :critical, creator: support_team.first, team: support_team.first, due_date: 1.day.from_now },
  { title: "Dashboard slow on large datasets", description: "When a team has more than 1000 requests, the dashboard takes over 10 seconds to load.", status: :open, priority: :high, creator: dev_team.first, team: dev_team.first, due_date: 3.days.from_now },
  { title: "Email notifications not sending", description: "Support request creators are not receiving email notifications when their requests are updated.", status: :open, priority: :medium, creator: support_team.last, team: support_team.last, due_date: 5.days.from_now },
  { title: "Filter by priority not working", description: "Clicking on the priority filter does not update the request list.", status: :open, priority: :low, creator: qa_team.first, team: qa_team.first, due_date: 7.days.from_now },
  { title: "Cannot assign request to inactive member", description: "The system allows assigning requests to inactive team members, causing silent failures.", status: :in_progress, priority: :high, creator: support_team.first, assignee: dev_team.first, team: dev_team.first, due_date: 2.days.from_now },
  { title: "Comment validation error", description: "Users can submit comments with empty body. Should require minimum 10 characters.", status: :in_progress, priority: :medium, creator: qa_team.first, assignee: dev_team.last, team: dev_team.first, due_date: 4.days.from_now },
  { title: "Mobile responsive layout broken", description: "The request detail page does not render correctly on mobile devices under 768px width.", status: :in_progress, priority: :medium, creator: support_team.last, assignee: dev_team[1], team: dev_team.first, due_date: 6.days.from_now },
  { title: "Search feature returns duplicates", description: "Searching by title sometimes returns the same request multiple times.", status: :in_progress, priority: :high, creator: dev_team.first, assignee: dev_team.first, team: dev_team.first, due_date: 1.day.from_now },
  # Resolved/Closed will be created as open first, then updated after adding comments
  { title: "Duplicate account creation", description: "Users were able to create multiple accounts with the same email address.", status: :open, priority: :critical, creator: support_team.first, assignee: dev_team.first, team: dev_team.first, due_date: 2.days.ago },
  { title: "Wrong status shown on dashboard", description: "The dashboard was showing open requests count instead of in_progress.", status: :open, priority: :medium, creator: qa_team.first, assignee: dev_team[1], team: dev_team.first, due_date: 1.day.ago },
  { title: "API returning 500 on empty team", description: "GET /api/v1/team_members returned internal server error when no members existed.", status: :open, priority: :high, creator: dev_team.last, assignee: dev_team.first, team: dev_team.first, due_date: 3.days.ago },
  { title: "Pagination not working", description: "The next page button on the request list was not navigating correctly.", status: :open, priority: :low, creator: qa_team.first, assignee: dev_team.first, team: dev_team.first, due_date: 5.days.ago },
  { title: "Missing favicon", description: "The browser tab showed the default Rails icon instead of the SupportFlow logo.", status: :open, priority: :low, creator: support_team.last, assignee: dev_team[1], team: dev_team.first, due_date: 4.days.ago },
  { title: "Dark mode color contrast issues", description: "Some text elements are hard to read in dark mode due to low contrast ratios.", status: :open, priority: :medium, creator: qa_team.first, team: qa_team.first, due_date: 3.days.from_now },
  { title: "Export to CSV feature request", description: "Managers need to export filtered support requests to CSV for weekly reports.", status: :open, priority: :low, creator: support_team.first, team: support_team.first, due_date: 10.days.from_now },
  { title: "Overdue requests not highlighted", description: "Requests past their due date should have a visual indicator.", status: :open, priority: :high, creator: dev_team.first, team: dev_team.first, due_date: 2.days.ago }
]
